...
INSERT INTO `expire` (`id`, `medicine_name`, `company_name`, `number_tablets`, `store_name`, `store_address`, `status`) VALUES
(1, 'Calpol', 'Paracetamol', 20, 'Gita Medicine Corner', 'B-17/176, near I.T.I More, Kalyani, West Bengal 741235', 0);
...
CREATE TABLE `orders` (
  `id` int(255) NOT NULL,
  `ngo` varchar(60) NOT NULL,
  `ngo_address` varchar(150) NOT NULL,
...
INSERT INTO `orders` (`id`, `ngo`, `ngo_address`, `store`, `medicine_name`, `number_tablets`, `dod`, `status`) VALUES
...
(18, 'Maheshwari NGO', 'Bangur Park', 'Gita Medicine Corner', 'Calpol-Paracetamol', 10, '2022-05-11', 1);
...
(40, 'Gita', 'Gita Medicine Corner', 'Calpol', 10, 'Paracetamol', '2022-05-13', 22.962732, 88.428391);
...
(58, 'Paracetamol', 'New Town, Kolkata', '1234567890', 'Para', 'paracetamol@gmail.com', '12345', 'company'),
(59, 'Maheshwari NGO', 'Bangur Park', '9876543210', 'Mahesh', 'maheshwari@gmail.com', '12345', 'ngo');
