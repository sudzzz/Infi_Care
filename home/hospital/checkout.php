...
if(isset($_POST['submit']))
{
  ...
  if($number<=$number_tablets)
  {
    ...
    $mysqli->query("INSERT INTO orders(hospital,hospital_address,store,medicine_name,number_tablets,dod,status) VALUES('$hospital','$hospital_address','$store','$medicine_name','$number','$dod',$status)") or die($mysqli->error);
    echo "<script> alert('Your Order has been placed successfully!!'); window.location = 'hospital.php'</script>";
